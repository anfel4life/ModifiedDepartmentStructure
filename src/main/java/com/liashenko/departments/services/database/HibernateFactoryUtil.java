...
public abstract class HibernateFactoryUtil {
    ...
    public static void closeFactory() {
        if (sessionFactory != null) {
            try {
                ...
                classLogger.error("Couldn't close SessionFactory", ignored);
            }
        }
    }
    ...
    public static void close(Session session) {
        if (session != null) {
            try {
                ...
                classLogger.error("Couldn't close Session", ignored);
            }
        }
    }
    ...
    public static void rollback(Transaction tx) {
        try {
            ...
            classLogger.error("Couldn't rollback Transaction", ignored);
        }
    }
}
