...
public abstract class CommandsHolderUtils implements Serializable {
    ...
    static {
        commandPermissionsMap.put(NodeGeneratorUtil.ROOT_NODE_TYPE, rootCommands);
        commandPermissionsMap.put(NodeGeneratorUtil.DEPARTMENT_NODE_TYPE, departmentCommands);
        commandPermissionsMap.put(NodeGeneratorUtil.EMPLOYEE_NODE_TYPE, employeeCommands);
